...
SVC_NAME="actions.runner.kimcj7957-seoul_darak.gimchanjin-ui-MacBookAir"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (kimcj7957-seoul_darak.gimchanjin-ui-MacBookAir)"
